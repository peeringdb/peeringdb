...
urlpatterns = [
    ...
    url(r"^security_keys/request_registration$", security_keys_views.request_registration),
    url(r"^security_keys/request_authentication$", security_keys_views.request_authentication),
