    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('log', models.TextField(blank=True, help_text='Activity for this entry')),
                ('dismissed', models.BooleanField(default=False, help_text="Network's dismissal of this proposed change, which will hide it until from the customer facing network view")),
