    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_long', models.CharField(blank=True, max_length=255, verbose_name='Long Name')),
                ('website', django_peeringdb.models.abstract.URLField(max_length=255, verbose_name='Website')),
                ('notes', models.TextField(blank=True, verbose_name='Notes')),
                ('org', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='carrier_set', to='peeringdb_server.organization')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', django_handleref.models.UpdatedDateTimeField(auto_now=True, verbose_name='Updated')),
                ('version', models.IntegerField(default=0)),
                ('carrier', models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, related_name='carrierfac_set', to='peeringdb_server.carrier')),
                ('facility', models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, related_name='carrierfac_set', to='peeringdb_server.facility')),
            ],
            options={
