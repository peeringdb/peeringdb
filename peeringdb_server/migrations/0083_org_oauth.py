    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('org', models.ForeignKey(blank=True, help_text='application is owned by this organization', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='oauth_applications', to='peeringdb_server.organization')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='peeringdb_server_oauthapplication', to=settings.AUTH_USER_MODEL)),
            ],
            options={
