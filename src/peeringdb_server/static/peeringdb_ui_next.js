PeeringDB = {
  ...
  function updateNavbarMode(isDark) {
  ...
  function setMode(mode) {
    ...
    const isUiNext = $('#header').data('ui-next');

    if (isDark) {
      document.documentElement.dataset.theme = 'dark';
    } else {
      document.documentElement.dataset.theme = isUiNext ? 'light-ui-next' : 'light';
    }

    updateImages(isDark);
    updateNavbarMode(isDark);
  }
