# Generated by Django 5.2.14 on 2026-06-03 23:08
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name='facility',
            index=models.Index(fields=['status', 'updated'], name='fac_status_updated'),
        ),
        migrations.AddIndex(
            model_name='facility',
            index=models.Index(fields=['country'], name='fac_country'),
        ),
        migrations.AddIndex(
            model_name='facility',
            index=models.Index(fields=['state'], name='fac_state'),
        ),
        migrations.AddIndex(
            model_name='internetexchange',
            index=models.Index(fields=['status', 'updated'], name='ix_status_updated'),
        ),
        migrations.AddIndex(
            model_name='internetexchange',
            index=models.Index(fields=['country'], name='ix_country'),
        ),
        migrations.AddIndex(
            model_name='network',
            index=models.Index(fields=['status', 'updated'], name='net_status_updated'),
        ),
        migrations.AddIndex(
            model_name='networkfacility',
            index=models.Index(fields=['status', 'updated'], name='netfac_status_updated'),
        ),
        migrations.AddIndex(
            model_name='networkixlan',
            index=models.Index(fields=['status', 'updated'], name='netixlan_status_updated'),
        ),
        migrations.AddIndex(
            model_name='organization',
            index=models.Index(fields=['status', 'updated'], name='org_status_updated'),
        ),
        migrations.AddIndex(
            model_name='organization',
            index=models.Index(fields=['country'], name='org_country'),
        ),
        migrations.AddIndex(
            model_name='organization',
            index=models.Index(fields=['state'], name='org_state'),
        ),
    ]
