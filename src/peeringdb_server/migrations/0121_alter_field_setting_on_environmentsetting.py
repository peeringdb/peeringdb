...
class Migration(migrations.Migration):
    def update_field_from_setting(apps, schema_editor):
        environmentsetting = apps.get_model("peeringdb_server", "EnvironmentSetting")
        setting_value = getattr(settings, "DATABASE_LAST_SYNC", None)
        env, created = environmentsetting.objects.get_or_create(
            setting="DATABASE_LAST_SYNC"
        )
        env.value = setting_value
        env.save()

    dependencies = [
        ("peeringdb_server", "0120_remove_network_info_type"),
    ]
    ...
    operations = [
        ...
        migrations.RunPython(update_field_from_setting),
    ]
