...
## [location.py](/docs/dev/modules/location.py.md)

Google location selection and signed entity confirmations.

## [location_views.py](/docs/dev/modules/location_views.py.md)
...
## [meta_registry.py](/docs/dev/modules/meta_registry.py.md)
